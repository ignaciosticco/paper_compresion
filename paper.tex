...
Despite the presence of the FIS or FIF phenomenon, the evacuation time at a fixed value of $v_d$ decreases for increasing values of $k$. This means that stiffer pedestrians evacuate faster than soft pedestrians. In order to investigate this issue, we computed the mean velocity of the whole crowd as a function of the stiffens $k$. \textcolor{red}{agregar figura velocidad (k)}. \\
...
The regime for $v_d<2\,$m/s can be... \textcolor{red}{completar}.\\

Besides, for a given $v_d$, the overlap increases as the $k$ value decreases. \textcolor{red}{Reducing $k$ means reducing the normal body force which allows a greater invasion of the personal space of the individuals.} The increment in mean overlap, however, seems to be more significant than the mean degree. \\  
