...
Helbing and co-workers \textcolor{red}{\sout{is somewhat cumbersome} appears to have some drawbacks} 
...
\begin{itemize}
\item[(i)] \textcolor{red}{\textbf{The walking attitude of a pedestrian may appear somewhat 
...
stands for \textcolor{red}{both} the sliding friction and the compression between 
pedestrians. \\
