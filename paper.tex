...
step  \cite{johansson_2009}. \textcolor{red}{\sout{This (perceived) step distance 
is therefore an influential parameter on the pedestrians behavior.} The perceived 
step distance is associated with the personal space (private-sphere),
 which therefore influences the pedestrian behavior. } 
