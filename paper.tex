...
\begin{figure}[!htbp]
\centering
    \subfloat[]{\includegraphics[width=0.45\columnwidth]{./flow-density_multifric_nocomp.eps}\label{flow_density_nocomp}}\ 
    \subfloat[]{\includegraphics[width=0.45\columnwidth]{./flow-density_multifric_comp.eps}\label{flow_density_comp}}\\
