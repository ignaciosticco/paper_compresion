...
Helbing and co-workers \textcolor{red}{\sout{is somewhat cumbersome} has some drawbacks} 
...
explain the phenomenon, the researcher \textcolor{red}{\sout{looses sight} may loose sight} of the dimensionless 
...
slowing down, but other behaviors are also possible \cite{helbing_2007,lohner_2018}. \textcolor{red}{
...
(her) moving ``attitude'' (say,\textcolor{red}{\sout{self-assuredness} relaxed, normal, aggressive, etc}).
...
pedestrians. Some \textcolor{blue}{\sout{settings} sets}, however, yield similar collective dynamics.
...
``loosely'' that any numerical \textcolor{blue}{\sout{setting} set} of these parameters may be 
