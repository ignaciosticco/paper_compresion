...
does the body stiffness interact with the walls} do the pedestrians interact with the walls as
...
The crowd behaves like a solid for very stiff pedestrians. This means that the crowd can not be easily ``deformed''. In this context, deformation means that parts of the crowd may be \textcolor{blue}{\sout{released} allowed} to move faster than other parts of the crowd. \\
