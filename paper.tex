...
% Pabell\'on I, Ciudad Universitaria, 1428 Buenos Aires, Argentina.}%
% \altaffiliation[Also at ]{Instituto de F\'\i sica de Buenos Aires, Pabell\'on 
%I, Ciudad Universitaria, 1428 Buenos Aires, Argentina.}
\address[add3]{Instituto de F\'\i sica de Buenos Aires,
Pabell\'on I, Ciudad Universitaria, 1428 Buenos Aires, Argentina.}
 %\affiliation{Departamento de F\'\i sica, Facultad de Ciencias 
%Exactas y Naturales, Universidad de Buenos Aires,\\
% Pabell\'on I, Ciudad Universitaria, 1428 Buenos Aires, Argentina.}
...
\section{\label{appendix_1} Reduced-in-units equation of motion}
