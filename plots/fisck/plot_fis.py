...
data_kcomp_E4 = pd.read_csv("tevsvd_ck_kcomp_E4.txt", header=None,delimiter=' ') 
...
data_kcomp_E5 = pd.read_csv("tevsvd_ck_kcomp_E5.txt", header=None,delimiter=' ') 
...
data = pd.read_csv("tevsvd_ck_sincomp.txt", header=None,delimiter=' ') 
...
pylab.ylabel('$t_e$~(s)')
pylab.title("N = 1300 - Original Friction - Door = 3~m (7p)")
#pylab.ylim(40, 80)
lgd=plt.legend(numpoints=1,handlelength=0.8) 
plt.legend(frameon=False,loc='best',labelspacing=-0.1,borderpad=0.3,handletextpad=0.5,fontsize=6,numpoints=1) 

pylab.savefig('vd_vs_te_ck.png', format='png', dpi=300, bbox_inches='tight')
pylab.savefig('vd_vs_te_ck.eps', format='eps', dpi=300, bbox_inches='tight')
