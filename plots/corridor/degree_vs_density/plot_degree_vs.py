...
###  DATA  ###
data_kn0 = pd.read_csv("degree_vs_dens_kn0.txt",sep="\t")
vd_kn0 = data_kn0["dens"].tolist()
...
data_kn = pd.read_csv("degree_vs_dens_kn1.2E5.txt",sep="\t")
vd_kn = data_kn["dens"].tolist()
mean_degree_kn = data_kn["list_mean_degree"].tolist()
std_degree_kn = data_kn["list_std_degree"].tolist()

data_knE6 = pd.read_csv("degree_vs_dens_kn1.2E6.txt",sep="\t")
vd_knE6 = data_knE6["dens"].tolist()
mean_degree_knE6 = data_knE6["list_mean_degree"].tolist()
std_degree_knE6 = data_knE6["list_std_degree"].tolist()
...
pylab.savefig('degree_vs_dens_multi_kn.png', format='png', dpi=300, bbox_inches='tight')
pylab.savefig('degree_vs_dens_multi_kn.eps', format='eps', dpi=300, bbox_inches='tight')
