...
plt.plot(k_d5_5,mean_vx_d5_5,'-bx',mew=0.7,markeredgecolor='k',markersize=4,zorder=1,label='$d=5.5$')
plt.plot(k_d6,mean_vx_d6,'-y^',mew=0.7,markeredgecolor='k',markersize=4,zorder=1,label='$d=6$') 
#plt.plot(k_d7,mean_vx_d7,'-cs',mew=0.7,markeredgecolor='k',markersize=4,zorder=3,label='$d=7$') 
plt.plot(k_d8,mean_vx_d8,'-rv',mew=0.7,markeredgecolor='k',markersize=4,zorder=1,label='$d=8$') 
